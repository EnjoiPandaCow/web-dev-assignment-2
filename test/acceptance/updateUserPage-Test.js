...
test.describe('Update User Page', function() {
    this.timeout(mochaTimeOut);
    test.before( function() {
        driver = new webdriver.Builder()
            .withCapabilities( webdriver.Capabilities.chrome() )
            .build();
        pageSelector = By.id('updateUserPage');
    ...
    test.beforeEach( function() {
        driver.get('http://localhost:3000/?#/updateUser');
        ...
        driver.findElement(By.tagName('h1'))
            .then(function(element) {
                element.getText().then(function(text){
                    expect(text).to.equal('Update a User');
                })
            });
    } );
    test.it( 'shows details h3', function() {
        driver.findElement(By.tagName('h3'))
            .then(function(element) {
                element.getText().then(function(text){
                    expect(text).to.equal('Please Enter Updated User Details Below');
                })
            });
    } );
    ...
    test.it( 'updates a user', function() {
        ...
        input
            ...
            .then(function(){
                return driver.findElement(By.id('updateUserBtn'));
            })
            .then(function(element){
                element.submit();
            })
